...
class ksAdditionFormatParam(DispatchBaseClass):
	...
	def LoadConfigurationFile(self, fileName=defaultNamedNotOptArg):
		'Загрузить конфигурацию из файла.'
		return self._oleobj_.InvokeTypes(28, LCID, 1, (3, 0), ((8, 0),),fileName
			)

	def SaveConfigurationFile(self, fileName=defaultNamedNotOptArg):
		'Сохранить конфигурацию в файл.'
		return self._oleobj_.InvokeTypes(27, LCID, 1, (3, 0), ((8, 0),),fileName
			)
	...
	_prop_map_get_ = {
		...
		"configuration": (25, 2, (12, 0), (), "configuration", None),
		"configurationFileName": (26, 2, (8, 0), (), "configurationFileName", None),
	...
	_prop_map_put_ = {
		...
		"author" : ((15, LCID, 4, 0),()),
		"comment" : ((17, LCID, 4, 0),()),
		"configuration" : ((25, LCID, 4, 0),()),
		"configurationFileName" : ((26, LCID, 4, 0),()),
...
class ksDocument3D(DispatchBaseClass):
	...
	def IsEditMode(self):
		'True - режим редактирования через библиотеку.'
		return self._oleobj_.InvokeTypes(10, LCID, 1, (11, 0), (),)
...
class ksFaceDefinition(DispatchBaseClass):
	...
	def GetAreaEx(self, bitVector=defaultNamedNotOptArg, angleTolerance=defaultNamedNotOptArg):
		'Получить площадь грани (ST_MIX_MM..ST_MIX_M еденицы измерения.'
		return self._oleobj_.InvokeTypes(22, LCID, 1, (5, 0), ((19, 0), (5, 0)),bitVector
			, angleTolerance)
...
class ksKompasObjectNotify:
	...
	# Event Handlers
	# If you create handlers, they should have the following prototypes:
#	def OnBeginDragOpenFiles(self, filesList=defaultNamedNotOptArg, insert=defaultNamedNotOptArg, filesListChanged=defaultNamedNotOptArg):
...
class ksRasterFormatParam(DispatchBaseClass):
	...
	_prop_map_get_ = {
		...
		"resultArrayBytes": (14, 2, (12, 0), (), "resultArrayBytes", None),
		"returnResultAsArrayBytes": (13, 2, (11, 0), (), "returnResultAsArrayBytes", None),
	...
	_prop_map_put_ = {
		...
		"resultArrayBytes" : ((14, LCID, 4, 0),()),
		"returnResultAsArrayBytes" : ((13, LCID, 4, 0),()),
...
class ksSpecification(DispatchBaseClass):
	...
	def ksGetSpcObjectSummaryCountText(self, spcObj=defaultNamedNotOptArg, ispoln=defaultNamedNotOptArg, block=defaultNamedNotOptArg):
		'Выдать отображаемый текст объекта СП для колонки количество и исполнения в виде динамического массива'
		return self._oleobj_.InvokeTypes(51, LCID, 1, (3, 0), ((3, 0), (3, 0), (3, 0)),spcObj
			, ispoln, block)
...
class ksSurface(DispatchBaseClass):
	...
	def GetAreaEx(self, bitVector=defaultNamedNotOptArg, angleTolerance=defaultNamedNotOptArg):
		'Получить площадь грани (ST_MIX_MM..ST_MIX_M еденицы измерения.'
		return self._oleobj_.InvokeTypes(37, LCID, 1, (5, 0), ((19, 0), (5, 0)),bitVector
			, angleTolerance)
