...
# Радиальный шарикоподшипник (не работающий, упрощённая модель)
# Нужно доработать - добавить сепаратор, дорожки качения, фаски(как отдельную команду), возможность вырезания вокруг оси и т.п.
